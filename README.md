...
```
$ curl -L -O https://github.com/cyberark/summon-conjur/releases/download/v0.2.0/summon-conjur_v0.2.0_linux-amd64.tar.gz
$ tar -xvzf summon-conjur_v0.2.0_linux-amd64.tar.gz
